<template lang="pug">
  q-page.flex.column.full-width
    ...
    template(v-if="state.selectedSet")
      ...
      q-scroll-area.q-pa-md(style="height:calc(100vh - 240px); height:calc(100dvh - 240px);" v-if="!state.showSetModels")
      ...
      q-scroll-area.q-pa-md(style="height:calc(100vh - 240px); height:calc(100dvh - 240px);" v-else)
        .centered
    ...
    template(v-else)
      q-scroll-area.full-width.q-pa-md(style="height:calc(100vh - 240px); height:calc(100dvh - 240px);")
