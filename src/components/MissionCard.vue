...
q-card.mission-card
  // Top content
  q-card-section
    // Header row: title + claim button
    .row.items-center.justify-between.q-gutter-sm
      h4.text-capitalize.q-mb-none {{ title }}
      q-btn(
    ...
    // Full-width details below header
    .text-subtitle1.q-mt-xs {{ mission.description }}
    // Rewards and community info
