...
export const statsActivity = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<StatsActivity200>> => {
    
    
    return axios.get(
      `/stats/activity`,options
    );
  }


export const getStatsActivityQueryKey = () => {
    return ['stats','activity'] as const;
    }

    
export const getStatsActivityQueryOptions = <TData = Awaited<ReturnType<typeof statsActivity>>, TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof statsActivity>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  getStatsActivityQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof statsActivity>>> = ({ signal }) => statsActivity({ signal, ...axiosOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof statsActivity>>, TError, TData> 
}

export type StatsActivityQueryResult = NonNullable<Awaited<ReturnType<typeof statsActivity>>>
export type StatsActivityQueryError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>



export function useStatsActivity<TData = Awaited<ReturnType<typeof statsActivity>>, TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof statsActivity>>, TError, TData>>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient 
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {

  const queryOptions = getStatsActivityQueryOptions(options)
...
export const statsFreeCreditsDaily = (
    params?: MaybeRef<StatsFreeCreditsDailyParams>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<StatsFreeCreditsDaily200>> => {
    params = unref(params);
    
    return axios.get(
      `/stats/freeCreditsDaily`,{
    ...options,
        params: {...unref(params), ...options?.params},}
    );
  }
...
export const getStatsFreeCreditsDailyQueryKey = (params?: MaybeRef<StatsFreeCreditsDailyParams>,) => {
    return ['stats','freeCreditsDaily', ...(params ? [params]: [])] as const;
    }

    
export const getStatsFreeCreditsDailyQueryOptions = <TData = Awaited<ReturnType<typeof statsFreeCreditsDaily>>, TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>>(params?: MaybeRef<StatsFreeCreditsDailyParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof statsFreeCreditsDaily>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  getStatsFreeCreditsDailyQueryKey(params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof statsFreeCreditsDaily>>> = ({ signal }) => statsFreeCreditsDaily(params, { signal, ...axiosOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof statsFreeCreditsDaily>>, TError, TData> 
}

export type StatsFreeCreditsDailyQueryResult = NonNullable<Awaited<ReturnType<typeof statsFreeCreditsDaily>>>
export type StatsFreeCreditsDailyQueryError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>



export function useStatsFreeCreditsDaily<TData = Awaited<ReturnType<typeof statsFreeCreditsDaily>>, TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>>(
 params?: MaybeRef<StatsFreeCreditsDailyParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof statsFreeCreditsDaily>>, TError, TData>>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient 
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {

  const queryOptions = getStatsFreeCreditsDailyQueryOptions(params,options)
...
export const adminListUsers = (
    adminListUsersBody: MaybeRef<AdminListUsersBody>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<AdminListUsers200>> => {
    adminListUsersBody = unref(adminListUsersBody);
    
    return axios.post(
      `/admin/listUsers`,
      adminListUsersBody,options
    );
  }



export const getAdminListUsersMutationOptions = <TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorINTERNALSERVERERROR>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminListUsers>>, TError,{data: AdminListUsersBody}, TContext>, axios?: AxiosRequestConfig}
): UseMutationOptions<Awaited<ReturnType<typeof adminListUsers>>, TError,{data: AdminListUsersBody}, TContext> => {

const mutationKey = ['adminListUsers'];
const {mutation: mutationOptions, axios: axiosOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof adminListUsers>>, {data: AdminListUsersBody}> = (props) => {
          const {data} = props ?? {};

          return  adminListUsers(data,axiosOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AdminListUsersMutationResult = NonNullable<Awaited<ReturnType<typeof adminListUsers>>>
    export type AdminListUsersMutationBody = AdminListUsersBody
    export type AdminListUsersMutationError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorINTERNALSERVERERROR>

    export const useAdminListUsers = <TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorINTERNALSERVERERROR>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminListUsers>>, TError,{data: AdminListUsersBody}, TContext>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof adminListUsers>>,
        TError,
        {data: AdminListUsersBody},
        TContext
      > => {

      const mutationOptions = getAdminListUsersMutationOptions(options);
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  getAdminEmailFunnelsOverviewQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof adminEmailFunnelsOverview>>, TError, TData> 
}

export type AdminEmailFunnelsOverviewQueryResult = NonNullable<Awaited<ReturnType<typeof adminEmailFunnelsOverview>>>
export type AdminEmailFunnelsOverviewQueryError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>
...
export const adminEmailFunnelSetActive = (
    adminEmailFunnelSetActiveBody: MaybeRef<AdminEmailFunnelSetActiveBody>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<AdminEmailFunnelSetActive200>> => {
    adminEmailFunnelSetActiveBody = unref(adminEmailFunnelSetActiveBody);
    
    return axios.post(
      `/admin/emailFunnelSetActive`,
      adminEmailFunnelSetActiveBody,options
    );
  }



export const getAdminEmailFunnelSetActiveMutationOptions = <TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorINTERNALSERVERERROR>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminEmailFunnelSetActive>>, TError,{data: AdminEmailFunnelSetActiveBody}, TContext>, axios?: AxiosRequestConfig}
): UseMutationOptions<Awaited<ReturnType<typeof adminEmailFunnelSetActive>>, TError,{data: AdminEmailFunnelSetActiveBody}, TContext> => {

const mutationKey = ['adminEmailFunnelSetActive'];
const {mutation: mutationOptions, axios: axiosOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof adminEmailFunnelSetActive>>, {data: AdminEmailFunnelSetActiveBody}> = (props) => {
          const {data} = props ?? {};

          return  adminEmailFunnelSetActive(data,axiosOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AdminEmailFunnelSetActiveMutationResult = NonNullable<Awaited<ReturnType<typeof adminEmailFunnelSetActive>>>
    export type AdminEmailFunnelSetActiveMutationBody = AdminEmailFunnelSetActiveBody
    export type AdminEmailFunnelSetActiveMutationError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorINTERNALSERVERERROR>

    export const useAdminEmailFunnelSetActive = <TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorINTERNALSERVERERROR>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminEmailFunnelSetActive>>, TError,{data: AdminEmailFunnelSetActiveBody}, TContext>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof adminEmailFunnelSetActive>>,
        TError,
        {data: AdminEmailFunnelSetActiveBody},
        TContext
      > => {

      const mutationOptions = getAdminEmailFunnelSetActiveMutationOptions(options);

      return useMutation(mutationOptions , queryClient);
    }
    
export const adminListEmailFunnelEmails = (
    params?: MaybeRef<AdminListEmailFunnelEmailsParams>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<AdminListEmailFunnelEmails200>> => {
    params = unref(params);
    
    return axios.get(
      `/admin/listEmailFunnelEmails`,{
    ...options,
        params: {...unref(params), ...options?.params},}
    );
  }
...
export const getAdminListEmailFunnelEmailsQueryKey = (params?: MaybeRef<AdminListEmailFunnelEmailsParams>,) => {
    return ['admin','listEmailFunnelEmails', ...(params ? [params]: [])] as const;
    }

    
export const getAdminListEmailFunnelEmailsQueryOptions = <TData = Awaited<ReturnType<typeof adminListEmailFunnelEmails>>, TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>>(params?: MaybeRef<AdminListEmailFunnelEmailsParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof adminListEmailFunnelEmails>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  getAdminListEmailFunnelEmailsQueryKey(params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof adminListEmailFunnelEmails>>> = ({ signal }) => adminListEmailFunnelEmails(params, { signal, ...axiosOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof adminListEmailFunnelEmails>>, TError, TData> 
}

export type AdminListEmailFunnelEmailsQueryResult = NonNullable<Awaited<ReturnType<typeof adminListEmailFunnelEmails>>>
export type AdminListEmailFunnelEmailsQueryError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>



export function useAdminListEmailFunnelEmails<TData = Awaited<ReturnType<typeof adminListEmailFunnelEmails>>, TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorNOTFOUND | ErrorINTERNALSERVERERROR>>(
 params?: MaybeRef<AdminListEmailFunnelEmailsParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof adminListEmailFunnelEmails>>, TError, TData>>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient 
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
...
export const motdSendTelegram = (
    motdSendTelegramBody: MaybeRef<MotdSendTelegramBody>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<MotdSendTelegram200>> => {
    motdSendTelegramBody = unref(motdSendTelegramBody);
    
    return axios.post(
      `/motd/sendTelegram`,
      motdSendTelegramBody,options
    );
  }



export const getMotdSendTelegramMutationOptions = <TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorINTERNALSERVERERROR>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof motdSendTelegram>>, TError,{data: MotdSendTelegramBody}, TContext>, axios?: AxiosRequestConfig}
): UseMutationOptions<Awaited<ReturnType<typeof motdSendTelegram>>, TError,{data: MotdSendTelegramBody}, TContext> => {

const mutationKey = ['motdSendTelegram'];
const {mutation: mutationOptions, axios: axiosOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof motdSendTelegram>>, {data: MotdSendTelegramBody}> = (props) => {
          const {data} = props ?? {};

          return  motdSendTelegram(data,axiosOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type MotdSendTelegramMutationResult = NonNullable<Awaited<ReturnType<typeof motdSendTelegram>>>
    export type MotdSendTelegramMutationBody = MotdSendTelegramBody
    export type MotdSendTelegramMutationError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorINTERNALSERVERERROR>

    export const useMotdSendTelegram = <TError = AxiosError<ErrorBADREQUEST | ErrorUNAUTHORIZED | ErrorFORBIDDEN | ErrorINTERNALSERVERERROR>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof motdSendTelegram>>, TError,{data: MotdSendTelegramBody}, TContext>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof motdSendTelegram>>,
        TError,
        {data: MotdSendTelegramBody},
        TContext
      > => {

      const mutationOptions = getMotdSendTelegramMutationOptions(options);
